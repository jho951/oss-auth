...
public final class MfaChallengeContext {
	...
	private static final MfaChallengeContext EMPTY = new MfaChallengeContext(null, MfaRiskLevel.UNKNOWN, com.auth.core.utils.CollectionUtils.mapOf());
	...
	public Optional<String> getActionIfPresent() {
		return Strings.isBlank(action) ? Optional.empty() : Optional.of(action);
	}
